...
export const BASE_COLORS: ColorRgbBase[] = [
  ...
  { name: "PLANT", r: 0, g: 124, b: 0, blocks: ["oak_leaves", "spruce_leaves", "birch_leaves", "jungle_leaves", "acacia_leaves", "dark_oak_leaves", "azalea_leaves", "flowering_azalea_leaves", "bamboo_block[axis=x]", "cactus", "sugar_cane", "fern", "short_grass", "tall_grass", "vine", "pink_petals", "wildflowers"] },
  ...
  { name: "WOOD", r: 143, g: 119, b: 72, blocks: ["oak_wood", "stripped_oak_wood", "oak_log", "stripped_oak_log", "oak_planks", "oak_slab", "oak_pressure_plate", "crafting_table", "bookshelf", "note_block", "daylight_detector", "composter", "beehive", "barrel", "petrified_oak_slab", "dead_bush"] },
  ...
  { name: "COLOR_YELLOW", r: 229, g: 229, b: 51, blocks: ["yellow_wool", "yellow_carpet", "yellow_concrete", "yellow_concrete_powder", "yellow_glazed_terracotta", "yellow_stained_glass", "yellow_candle", "bamboo_block", "bamboo_planks", "sponge", "wet_sponge", "hay_block", "bee_nest"] },
