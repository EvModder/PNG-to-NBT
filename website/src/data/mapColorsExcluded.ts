...
const EXCLUDED_BY_ID: Partial<Record<number, string[]>> = {
  ...
  2: [
    ...
    "chiseled_sandstone", "sandstone_stairs",
    "sandstone_wall",
  ...
  11: [
    ...
    "cracked_stone_bricks", "chiseled_stone_bricks", "stone_brick_stairs",
    "stone_brick_wall",
  ...
  14: [
    ...
    "pale_oak_stairs",
    "pale_oak_trapdoor",
    "chiseled_quartz_block", "quartz_stairs",
  ...
  15: [
    ...
    "acacia_stairs",
    "acacia_trapdoor",
    "chiseled_red_sandstone", "red_sandstone_stairs",
    "red_sandstone_wall",
    "smooth_red_sandstone_stairs",
    "creaking_heart",
    "waxed_chiseled_copper", "waxed_cut_copper_stairs",
  ...
  18: ["sulfur_stairs", "sulfur_wall", "polished_sulfur_stairs", "polished_sulfur_wall", "sulfur_brick_stairs", "sulfur_brick_wall", "chiseled_sulfur", "yellow_shulker_box", "bamboo_fence", "bamboo_fence_gate", "bamboo_sign", "bamboo_stairs", "bamboo_mosaic_stairs", "bamboo_trapdoor", "wheat[age=7]"],
  19: ["lime_shulker_box"],
  20: ["pink_shulker_box"],
  21: ["dried_ghast", "gray_shulker_box"],
  22: ["light_gray_shulker_box", "jigsaw", "structure_block", "test_block"],
  23: ["calibrated_sculk_sensor", "cyan_shulker_box", "prismarine_stairs", "prismarine_wall"],
  ...
  25: ["blue_shulker_box"],
  26: ["brown_shulker_box", "command_block", "dark_oak_fence", "dark_oak_fence_gate", "dark_oak_sign", "dark_oak_stairs", "dark_oak_trapdoor"],
  27: ["green_shulker_box", "end_portal_frame", "chain_command_block"],
  28: ["cinnabar_stairs", "cinnabar_wall", "polished_cinnabar_stairs", "polished_cinnabar_wall", "cinnabar_brick_stairs", "cinnabar_brick_wall", "chiseled_cinnabar", "red_shulker_box", "brick_stairs", "brick_wall", "enchanting_table", "mangrove_fence", "mangrove_fence_gate", "mangrove_sign", "mangrove_stairs", "mangrove_trapdoor"],
  29: ["gilded_blackstone", "blackstone_stairs", "blackstone_wall", "polished_blackstone_stairs", "polished_blackstone_wall", "chiseled_polished_blackstone", "cracked_polished_blackstone_bricks", "polished_blackstone_brick_stairs", "polished_blackstone_brick_wall", "black_shulker_box", "dragon_egg", "end_portal", "end_gateway", "respawn_anchor"],
  31: ["prismarine_brick_stairs", "dark_prismarine_stairs"],
  34: ["spruce_fence", "spruce_fence_gate", "spruce_sign", "spruce_stairs", "spruce_trapdoor"],
  35: ["cracked_nether_bricks", "chiseled_nether_bricks", "nether_brick_fence", "nether_brick_stairs", "nether_brick_wall", "red_nether_brick_stairs", "red_nether_brick_wall"],
  36: ["cherry_fence", "cherry_fence_gate", "cherry_sign", "cherry_stairs", "cherry_trapdoor"],
  37: ["chiseled_resin_bricks", "resin_brick_stairs", "resin_brick_wall"],
  43: ["polished_tuff_stairs", "polished_tuff_wall", "chiseled_tuff_bricks", "tuff_brick_stairs", "tuff_brick_wall", "chiseled_tuff", "tuff_stairs", "tuff_wall"],
  44: ["mud_brick_stairs", "mud_brick_wall", "waxed_exposed_chiseled_copper", "waxed_exposed_cut_copper_stairs", "waxed_exposed_copper_trapdoor", "waxed_exposed_copper_bulb", "waxed_exposed_lightning_rod", "waxed_exposed_copper_chest", "waxed_exposed_copper_golem_statue"],
  53: ["crimson_fence", "crimson_fence_gate", "crimson_sign", "crimson_stairs", "crimson_trapdoor"],
  55: ["waxed_oxidized_chiseled_copper", "waxed_oxidized_cut_copper_stairs", "waxed_oxidized_copper_trapdoor", "waxed_oxidized_copper_bulb", "waxed_oxidized_lightning_rod", "waxed_oxidized_copper_chest", "waxed_oxidized_copper_golem_statue", "oxidized_chiseled_copper", "oxidized_cut_copper_stairs", "oxidized_copper_trapdoor", "oxidized_copper_bulb", "oxidized_lightning_rod", "oxidized_copper_chest", "oxidized_copper_golem_statue"],
  56: [
    "warped_fence",
    "warped_fence_gate",
    "warped_sign",
    "warped_stairs",
    "warped_trapdoor",
    "waxed_weathered_chiseled_copper", "waxed_weathered_cut_copper_stairs",
  ...
  59: [
    "chiseled_deepslate", "cobbled_deepslate_stairs",
    "cobbled_deepslate_wall", "polished_deepslate_stairs", "polished_deepslate_wall",
    "cracked_deepslate_bricks", "deepslate_brick_stairs",
    "deepslate_brick_wall",
    "cracked_deepslate_tiles", "deepslate_tile_stairs",
    "deepslate_tile_wall",
    "infested_deepslate",
